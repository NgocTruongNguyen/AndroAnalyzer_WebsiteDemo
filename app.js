...
const hybridAnalysisRouter = require('./routes/hybridanalysis');
const homeRouter = require('./routes/myhome');
...
app.use('/hybridanalysis', middleware.onlyLoggedIn, hybridAnalysisRouter);
app.use('/', middleware.onlyLoggedIn, homeRouter);
